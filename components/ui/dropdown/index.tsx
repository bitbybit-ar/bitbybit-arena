...
export function Dropdown(props: DropdownProps) {
  ...
  }, [multiple, options, placeholder, singleValue, multiValue, allLabel, summaryFormatter]);
  ...
  return (
    <div ref={ref} className={cn(styles.dropdown, className)}>
      <button
        id={id}
        type="button"
        className={cn(styles.trigger, open && styles.triggerOpen, buttonClassName)}
      ...
      {open && (
        <ul className={styles.menu} role="listbox" aria-multiselectable={multiple}>
          {options.map((opt) => {
