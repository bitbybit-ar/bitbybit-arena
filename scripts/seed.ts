...
const MOCK_CHALLENGES: MockChallenge[] = [
  ...
  },
  {
    ...
    description:
      "Demo challenge for judges. Three mock participants have already completed; open the detail page as the creator and click \"Distribute rewards\" to trigger the NIP-57 zap payout loop end to end (50% / 30% / 20% of a 100 sat pot, kept tiny on purpose so you can pay it from any wallet during testing).",
    type: "competition",
    tags: ["demo"],
    verification_methods: ["automatic"],
    checkpoint_mode: "none",
